...
frappe.query_reports["BOM Item Warehouse Status Report"] = {
	"filters": [
	{
		...
		frappe.call({
			method: 			    				    					"nhance_cstm.nhance_cstm.report.bom_item_warehouse_status_report.bom_item_warehouse_status_report.fetch_Records",
			args: {
         	 		"docName":docName,
        	},
		async: false,
        ...
        },
	{
	   ...
	   "on_change": function(query_report){
		...
		if(docName=="Project"){
		frappe.call({
			method: 			    				    					"nhance_cstm.nhance_cstm.report.bom_item_warehouse_status_report.bom_item_warehouse_status_report.get_master_bom",
			args: {
         	 		"docId":docID,
				"docName":docName
        	},
