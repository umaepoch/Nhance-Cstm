        ...
        var dialog = new frappe.ui.Dialog({
            ...
            primary_action: function() {
                ...
                if (materialIssueList.length != 0) {
                    frappe.call({
                        method: "nhance_cstm.nhance_cstm.report.raw_material_variabilities.raw_material_variabilities.make_material_issue",
                        args: {
...
function getReportData() {
    var reportData = [];
    frappe.call({
        method: "nhance_cstm.nhance_cstm.report.raw_material_variabilities.raw_material_variabilities.get_report_data",
        async: false,
        callback: function(r) {
