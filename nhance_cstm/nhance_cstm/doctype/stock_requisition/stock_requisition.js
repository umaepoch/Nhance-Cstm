...
frappe.call({
           method: "nhance_cstm.nhance_cstm.doctype.stock_requisition.stock_requisition.fetch_conversion_factor",
           args: {
...
frappe.call({
	method: "nhance_cstm.nhance_cstm.doctype.stock_requisition.stock_requisition.update_po_list",
	args: {
         	 "srID":srID,
		 "po_list":poList
        },
